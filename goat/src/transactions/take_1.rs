...
use crate::connectors::connector_b::ConnectorB;
...
impl Take1Transaction {
    ...
    pub fn new(
        ...
        this.sign_input_3(context, connector_b);
    ...
    pub fn sign_input_3(&mut self, context: &OperatorContext, connector_b: &ConnectorB) {
        let input_index = 3;
        pre_sign_taproot_input_default(
            self,
            input_index,
