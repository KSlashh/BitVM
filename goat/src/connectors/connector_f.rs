...
use crate::{constants::CONNECTOR_F_TIMELOCK, utils::num_blocks_per_network};
...
impl ConnectorF {
    pub fn new(
        ...
        ConnectorF {
            ...
            take2_blocks_timelock: num_blocks_per_network(network, CONNECTOR_F_TIMELOCK),
        }
    }
    ...
    fn generate_taproot_leaf_0_script(&self) -> ScriptBuf {
        generate_timelock_taproot_script(
            ...
            self.take2_blocks_timelock,
        )
    }

    fn generate_taproot_leaf_0_tx_in(&self, input: &Input) -> TxIn {
        generate_timelock_tx_in(input, self.take2_blocks_timelock)
    }
...
impl TaprootConnector for ConnectorF {
