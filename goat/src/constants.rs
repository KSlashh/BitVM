...
// connectors' locktime
// TODO: adjust these timelocks
pub const CONNECTOR_Z_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 3; // pegin-cancel timelock
pub const CONNECTOR_A_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 3; // take-1 timelock
pub const CONNECTOR_C_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 3; // assert-init timelock
pub const CONNECTOR_D_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 3; // take-2 timelock
pub const CONNECTOR_F_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 7; // take-2 timelock
pub const CONNECTOR_G_TIMELOCK: u32 = WATCHTOWER_CHALLENGE_TIMELOCK; // operator commit blockhash timelock
pub const WATCHTOWER_CHALLENGE_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 3; // watchtower challenge timelock
pub const ACK_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 4; // operator ack timelock
