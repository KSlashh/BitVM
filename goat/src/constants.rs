...
pub const CONNECTOR_A_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 1; // take-1 timelock
pub const PROVER_CONNECTOR_TIMELOCK: u32 = NUM_BLOCKS_PER_DAY * 1; // disprove timelock for the prover connector
